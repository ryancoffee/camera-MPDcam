...
set yrange [ 0.00000 : 32.0000 ] noreverse nowriteback
...
GNUTERM = "x11"
GPFUN_file = "file(s,i) = sprintf('./data/%s.%03i',s,i)"
head = "tryhalf"
head = "tryfull"
head = "try8bit"
file(s,i) = sprintf('./data/%s.%03i',s,i)
set cbrange [0:25]
set xrange [0:32]
set yrange [0:64]
set auto cb
do for [i=0:9]{
	...
	set output sprintf('./figs/%s.%03i.png',head,i)
	splot file(head,i) mat
}
#    EOF
